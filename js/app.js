window.onload = function () {
  ...
  function loadGoogleMapsAPI() {
    ...
    (e.src =
      "https://maps.googleapis.com/maps/api/js?callback=loadMap&key=" + t),
  ...
  if (
    ((function (e, t) {
      ...
      function O(e, t, i, o) {
        ...
        if (
          g ||
          (f > 1 && "string" == typeof p && !fe.checkClone && tt.test(p))
        )
          ...
          if ((i = U.prefilters[r].call(c, e, u, c.opts)))
            return (
              pe.isFunction(i.stop) &&
                (pe._queueHooks(c.elem, c.opts.queue).stop = pe.proxy(
                  i.stop,
                  i
                )),
              i
            ...
            function (e) {
              ...
              return i !== I && 9 === i.nodeType && i.documentElement
                ? ((I = i),
                  ...
                  (w.getElementsByClassName = pe.test(
      ...
      pe.extend({
        ...
        clone: function (e, t, n) {
          ...
          if (t)
            if (n)
              for (
                r = r || y(e), s = s || y(a), i = 0, o = r.length;
                i < o;
                i++
              )
                A(r[i], s[i]);
        ...
        pe.each(
          ...
          function (e, t) {
            pe.fn[e] = function (e) {
              for (
                var n, i = [], o = pe(e), r = o.length - 1, s = 0;
                s <= r;
                s++
              )
              ...
              g = (function () {
                ...
                return (
                  (a.prototype.toggle = function () {
                    e(this._element).hasClass(f.SHOW)
                      ? this.hide()
                      : this.show();
                  }),
                ...
                return (
                  ...
                  (l.prototype._setEscapeEvent = function () {
                    ...
                    this._isShown && this._config.keyboard
                      ...
                      : this._isShown ||
                        e(this._element).off(d.KEYDOWN_DISMISS);
                  }),
              ...
              success: function (i) {
                "success" == i
                  ...
                  : (n
                      .fadeIn("slow")
                      .html(
                        '<div class="mt-3 help-block text-danger">' +
                          a +
                          "</div>"
                      )
                      .delay(3e3)
